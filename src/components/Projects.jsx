...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "NeuroNotes-AI",
      description: "AI-powered note-taking app that generates summaries and insights from user input using a custom-trained model.",
      tech: "React.js, Node.js, Express.js, Axios,Groq SDK",
      tags: [ "AI"],
     ...
     {
      title: "Sentiscope",
      description: "Sentiment analysis tool that classifies text as positive, negative, or neutral using a machine learning model.",
      tech: "Html,javascript,Node.js, Express.js",
